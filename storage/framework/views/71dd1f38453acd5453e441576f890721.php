...
<?php $__env->startSection('page-sub', 'Communicate with couriers, sellers, and buyers'); ?>
...
<div class="chat-shell">
  <div class="chat-list">
    ...
    <a href="<?php echo e(route('logistics.messages.thread', $u->id)); ?>" class="chat-conv <?php echo e(isset($activeUser) && $activeUser->id === $u->id ? 'active' : ''); ?>">
    ...
    <?php $__currentLoopData = $buyers->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <a href="<?php echo e(route('logistics.messages.thread', $u->id)); ?>" class="chat-conv <?php echo e(isset($activeUser) && $activeUser->id === $u->id ? 'active' : ''); ?>">
      <div class="avatar-sm"><?php echo e(strtoupper(substr($u->first_name,0,1).substr($u->last_name,0,1))); ?></div>
      <div class="meta">
        <strong><?php echo e($u->first_name); ?> <?php echo e($u->last_name); ?></strong>
    ...
    <?php if($couriers->isEmpty() && $sellers->isEmpty() && $buyers->isEmpty()): ?>
  ...
  <div class="chat-main">
    ...
    <div class="chat-body" id="chatBody">
      <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="bubble out">
          ...
          <time><?php echo e(\Carbon\Carbon::parse($msg->created_at)->format('M j, g:i a')); ?></time>
        </div>
        <?php else: ?>
        <div class="bubble in">
          <?php echo e($msg->body); ?>
    ...
    <form class="chat-input" method="POST" action="<?php echo e(route('logistics.messages.send', $activeUser->id)); ?>">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('logistics.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Chlouie Cabot\OneDrive\Desktop\pocketfinds\resources\views/logistics/messages.blade.php ENDPATH**/ ?>