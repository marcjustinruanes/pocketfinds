    ...
    <main class="auth-card">
        ...
        <section class="auth-form-panel">
            <div class="auth-form-wrap">
                ...
                <form id="buyerForm" method="POST" action="<?php echo e(route('register.store')); ?>" enctype="multipart/form-data" novalidate>
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="account_type" value="<?php echo e(request('type', 'buyer')); ?>">
...
<?php /**PATH C:\Users\Chlouie Cabot\OneDrive\Desktop\pocketfinds\resources\views/auth/register.blade.php ENDPATH**/ ?>