...
<title><?php echo e($product['name']); ?> — PocketFinds</title>
<link rel="stylesheet" href="<?php echo e(asset('css/marketplace.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/guest-product.css')); ?>">
</head>
...
<a href="<?php echo e(url()->previous() === url()->current() ? url('/') : url()->previous()); ?>" class="gp-back">
...
<div class="gp-grid">
  ...
  <div class="gp-img-col">
    <div class="gp-thumb-col">
      ...
      <div class="gp-thumb-viewport" id="gpThumbViewport">
        <div class="gp-thumb-track" id="gpThumbTrack">
          <?php $__currentLoopData = range(1,6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <button class="gp-thumb <?php echo e($t===1?'active':''); ?>" onclick="gpThumb(this)">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75"><?php echo $iconPath; ?></svg>
          </button>
    ...
    <div class="gp-main-img">
      <svg xmlns="http://www.w3.org/2000/svg" width="110" height="110" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75"><?php echo $iconPath; ?></svg>
    </div>
  </div>
  ...
  <div class="gp-right-col">
    <div class="gp-info-card">
      <div class="gp-crumb-row">
        <span class="gp-crumb"><?php echo e($product['cat']); ?></span>
        <?php if($product['badge']): ?><span class="gp-pill"><?php echo e($product['badge']); ?></span><?php endif; ?>
      </div>
      <div class="gp-title-price-row">
        <h1 class="gp-title"><?php echo e($product['name']); ?></h1>
        <div class="gp-price-block">
          <span class="gp-price">₱<?php echo e(number_format($product['price'])); ?></span>
          <?php if($product['old_price']): ?><span class="gp-old">₱<?php echo e(number_format($product['old_price'])); ?></span><?php endif; ?>
        </div>
      </div>
      <div class="gp-meta-row">
        ...
        <span class="gp-meta-val"><?php echo e($avg); ?></span>
        <span class="gp-meta-sep">·</span>
        <span class="gp-meta-muted"><?php echo e(number_format($product['sold'])); ?> sold</span>
        <span class="gp-meta-sep">·</span>
        <a class="gp-meta-link" href="#" onclick="event.preventDefault();gpTab('reviews')"><?php echo e(count($reviews)); ?> reviews</a>
      </div>
    ...
    <div class="gp-tabs-wrap">
      <div class="gp-tab-bar">
        ...
        <button class="gp-tab" onclick="gpTab('reviews')">Reviews <span class="gp-tab-count"><?php echo e(count($reviews)); ?></span></button>
      </div>

      <div class="gp-pane active" id="gp-options">
        <?php if(!empty($product['variants']['color'])): ?>
        <div class="gp-opt-group">
          ...
          <div class="gp-opt-row">
            ...
            <button class="gp-opt-btn <?php echo e($loop->first?'active':''); ?>" onclick="gpVariant(this)"><?php echo e($c); ?></button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class="gp-opt-group">
          <div class="gp-opt-label"><?php echo e(str_contains(implode(',',$product['variants']['size']),'Switch') ? 'Switch Type' : 'Size'); ?></div>
          <div class="gp-opt-row">
            ...
            <button class="gp-opt-btn <?php echo e($loop->first?'active':''); ?>" onclick="gpVariant(this)"><?php echo e($s); ?></button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
        <?php endif; ?>
      ...
      <div class="gp-pane" id="gp-details">
        <p class="gp-desc"><?php echo e($product['desc']); ?></p>
        <div class="gp-divider"></div>
        <div class="gp-specs">
          <?php $__currentLoopData = $product['specs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label,$val]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="gp-spec-row"><span class="gp-spec-key"><?php echo e($label); ?></span><span class="gp-spec-val"><?php echo e($val); ?></span></div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      </div>
      ...
      <div class="gp-pane" id="gp-reviews">
        <div class="gp-rev-filter">
          <div class="gp-rev-chips">
            ...
            <button class="gp-rev-chip" data-star="<?php echo e($star); ?>" onclick="gpFilterRev(<?php echo e($star); ?>)"><?php echo e($star); ?><svg width="8" height="8" viewBox="0 0 24 24" fill="currentColor" stroke="none" style="margin-left:1px"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          <div class="gp-rev-count">
            <span class="gp-rev-count-num" id="gpRevCountNum"><?php echo e(count($reviews)); ?></span>
        ...
        <div id="gpRevList">
          ...
          <div class="gp-rev-item <?php echo e($idx>=3?'gp-rev-hidden':''); ?>" data-rating="<?php echo e($r['rating']); ?>">
            <div class="gp-rev-av"><?php echo e(strtoupper(substr($r['name'],0,1))); ?></div>
            <div class="gp-rev-body">
              <div class="gp-rev-header">
                <span class="gp-rev-name"><?php echo e($r['name']); ?></span>
                ...
                <span class="gp-rev-date"><?php echo e($r['date']); ?></span>
              </div>
              <p class="gp-rev-text"><?php echo e($r['text']); ?></p>
            </div>
          </div>
...
<div class="gp-shop-more">
  <div class="gp-shop-more-head">
    <div style="display:flex;align-items:center;gap:12px">
      <div class="gp-shop-av"><?php echo e(strtoupper(substr($product['seller'],0,1))); ?></div>
      <div>
        <div class="gp-shop-name"><?php echo e($product['seller']); ?></div>
        <div class="gp-shop-sub">More from this shop</div>
      </div>
    </div>
    <a href="<?php echo e(route('guest.shop', $product['seller_slug'])); ?>" class="gp-shop-link">View Shop</a>
  </div>
  <div class="gp-mini-grid">
    ...
    <a class="gp-mini-card" href="<?php echo e(route('guest.product', $sp['id'])); ?>">
      <div class="gp-mini-img">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75"><?php echo $icons[$sp['img']] ?? $icons['bag']; ?></svg>
        <?php if($sp['badge']): ?><span class="gp-mini-badge"><?php echo e($sp['badge']); ?></span><?php endif; ?>
      </div>
      <div class="gp-mini-info">
        <div class="gp-mini-name"><?php echo e($sp['name']); ?></div>
        <div class="gp-mini-price">₱<?php echo e(number_format($sp['price'])); ?></div>
        <div class="gp-mini-rating"><svg width="10" height="10" viewBox="0 0 24 24" fill="#f59e0b" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> <?php echo e($sp['rating']); ?></div>
      </div>
    </a>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div>
...
<div class="gp-related">
  ...
  <div class="deal-grid">
    ...
    <a class="product" href="<?php echo e(route('guest.product', $rp['id'])); ?>" style="text-decoration:none;color:inherit">
      <div class="product-img">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><?php echo $icons[$rp['img']] ?? $icons['bag']; ?></svg>
      </div>
      <div class="product-body">
        <?php if($rp['badge']): ?><span class="badge"><?php echo e($rp['badge']); ?></span><?php endif; ?>
        <div class="product-name"><?php echo e($rp['name']); ?></div>
        <div class="price">₱<?php echo e(number_format($rp['price'])); ?></div>
        <div class="meta">
          <span class="meta-rating"><svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> <?php echo e($rp['rating']); ?></span>
          <span><?php echo e(number_format($rp['sold'])); ?> sold</span>
        </div>
...
const gpRevCounts = <?php echo json_encode($counts, 15, 512) ?>;
const gpRevTotal  = <?php echo e(count($reviews)); ?>;
...
<?php /**PATH C:\Users\Chlouie Cabot\OneDrive\Desktop\pocketfinds\resources\views/guest/product.blade.php ENDPATH**/ ?>