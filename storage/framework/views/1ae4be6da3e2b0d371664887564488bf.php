...
<title><?php echo e($shop['name']); ?> — PocketFinds</title>
...
<div class="gs-hero">
  <div class="gs-avatar"><?php echo e($shop['initial']); ?></div>
  <div class="gs-info">
    <h1 class="gs-name"><?php echo e($shop['name']); ?></h1>
    <div class="gs-rating-row">
      ...
      <?php endfor; ?>
      <span class="gs-rating-val"><?php echo e($shop['rating']); ?></span>
    </div>
    <p class="gs-desc"><?php echo e($shop['desc']); ?></p>
  </div>
  <div class="gs-stats">
    <div class="gs-stat"><div class="gs-stat-val"><?php echo e($shop['products']); ?></div><div class="gs-stat-label">Products</div></div>
    <div class="gs-stat"><div class="gs-stat-val"><?php echo e($shop['sales']); ?></div><div class="gs-stat-label">Sales</div></div>
    <div class="gs-stat"><div class="gs-stat-val"><?php echo e($shop['rating']); ?></div><div class="gs-stat-label">Rating</div></div>
    <div class="gs-stat"><div class="gs-stat-val"><?php echo e($shop['joined']); ?></div><div class="gs-stat-label">Joined</div></div>
  </div>
</div>

<div class="gs-products-head">
  <span>All Products</span>
  <span class="gs-products-count"><?php echo e(count($items)); ?> item<?php echo e(count($items)!==1?'s':''); ?></span>
</div>
...
<div class="deal-grid" style="margin-top:0">
  ...
  <a class="product" href="<?php echo e(route('guest.product', $p['id'])); ?>" style="text-decoration:none;color:inherit">
    <div class="product-img">
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><?php echo $icons[$p['img']] ?? $icons['bag']; ?></svg>
      <?php if($p['badge']): ?><span class="badge"><?php echo e($p['badge']); ?></span><?php endif; ?>
    </div>
    <div class="product-body">
      <div class="product-name"><?php echo e($p['name']); ?></div>
      <div class="price">₱<?php echo e(number_format($p['price'])); ?></div>
      <div class="meta">
        <span class="meta-rating"><svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> <?php echo e($p['rating']); ?></span>
        <span><?php echo e(number_format($p['sold'])); ?> sold</span>
      </div>
...
<?php /**PATH C:\Users\Administrator\pocketfinds\resources\views\guest\shop.blade.php ENDPATH**/ ?>