...
<title><?php echo $__env->yieldContent('title', 'Logistics'); ?> — PocketFinds</title>
...
<div class="shell" id="logisticsShell">
  <?php echo $__env->make('logistics.partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <div style="display:flex;flex-direction:column;min-width:0">
    <?php echo $__env->make('logistics.partials.topbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <main class="content">
...
<div class="modal-overlay" id="logoutOverlay">
  <div class="modal" style="max-width:380px">
    ...
    <div class="modal-foot">
      ...
      <form method="POST" action="<?php echo e(route('logistics.logout')); ?>">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Chlouie Cabot\OneDrive\Desktop\pocketfinds\resources\views/logistics/layout.blade.php ENDPATH**/ ?>