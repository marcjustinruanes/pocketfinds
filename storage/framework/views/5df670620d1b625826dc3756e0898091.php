...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['path' => null, 'label']));
...
foreach (array_filter((['path' => null, 'label']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
?>
<?php if($path): ?>
<button type="button" class="doc-thumb" data-doc-trigger data-src="<?php echo e($url); ?>" data-type="<?php echo e($type); ?>" data-title="<?php echo e($label); ?>">
...
<?php endif; ?>
        <?php else: ?>
            <img src="<?php echo e($url); ?>" alt="<?php echo e($label); ?>" loading="lazy">
        <?php endif; ?>
    </span>
    <span class="doc-thumb-label"><?php if (isset($component)) { $__componentOriginalc4dbd72dbbda5b9097ae9fdad9927c92 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc4dbd72dbbda5b9097ae9fdad9927c92 = $attributes; } ?>
...
<div class="doc-thumb missing">
    <span class="doc-thumb-img"><?php if (isset($component)) { $__componentOriginalc4dbd72dbbda5b9097ae9fdad9927c92 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc4dbd72dbbda5b9097ae9fdad9927c92 = $attributes; } ?>
...
<?php unset($__componentOriginalc4dbd72dbbda5b9097ae9fdad9927c92); ?>
<?php endif; ?></span>
    <span class="doc-thumb-label"><?php echo e($label); ?> — not submitted</span>
</div>
<?php endif; ?>
<?php /**PATH C:\Users\Chlouie Cabot\OneDrive\Desktop\pocketfinds\resources\views/components/admin-doc-thumb.blade.php ENDPATH**/ ?>