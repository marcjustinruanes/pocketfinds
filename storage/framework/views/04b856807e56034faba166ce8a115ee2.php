...
<?php $__env->startSection('page-title', 'Shipments'); ?>
<?php $__env->startSection('page-sub', 'Schedule courier pickup and track shipment status'); ?>
...
<div class="card">
  <div class="card-head">
    ...
    <button class="btn btn-sm btn-primary" data-modal="schedulePickupModal">
      <?php echo $__env->make('seller.partials.icon', ['name' => 'truck', 'size' => 14], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> Schedule Pickup
    </button>
  </div>
  <table class="tbl">
    <thead><tr>
    ...
    <tbody>
      <tr>
        ...
        <td style="font-size:12px;color:var(--muted)"><?php echo e(now()->addDays(2)->format('M d, Y')); ?></td>
        <td>
          <div class="tbl-actions">
            <button class="btn btn-sm btn-outline"><?php echo $__env->make('seller.partials.icon', ['name' => 'map-pin', 'size' => 13], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> Track</button>
            <button class="btn btn-sm btn-outline"><?php echo $__env->make('seller.partials.icon', ['name' => 'refresh', 'size' => 13], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> Update</button>
          </div>
        </td>
      </tr>
  ...
  <div class="modal">
    ...
    <div class="modal-body">
      ...
      <div class="form-grid-2">
        <div class="form-row"><label>Pickup Date</label><input type="date" value="<?php echo e(now()->format('Y-m-d')); ?>"></div>
    ...
    <div class="modal-foot">
      ...
      <button class="btn btn-primary"><?php echo $__env->make('seller.partials.icon', ['name' => 'truck', 'size' => 14], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> Confirm Pickup</button>
    </div>
  </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('seller.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\pocketfinds\resources\views\seller\shipments.blade.php ENDPATH**/ ?>