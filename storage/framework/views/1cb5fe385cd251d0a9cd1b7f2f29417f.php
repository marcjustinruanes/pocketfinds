  ...
  <div class="card">
    ...
    <div class="card-pad">
      <div style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
        ...
        <div>
          <div style="font-weight:700;font-size:15px"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></div>
          <div style="font-size:12px;color:var(--muted)"><?php echo e(auth()->user()->email); ?></div>
          <span class="stamp stamp-active" style="margin-top:4px"><?php echo e(ucfirst(auth()->user()->account_type)); ?></span>
        </div>
      </div>
      <form method="POST" action="<?php echo e(route('admin.account.update')); ?>">
        ...
        <div class="form-row">
          ...
          <input type="text" name="first_name" value="<?php echo e(old('first_name', auth()->user()->first_name)); ?>" required>
        </div>
        <div class="form-row">
          <label>Last Name</label>
          <input type="text" name="last_name" value="<?php echo e(old('last_name', auth()->user()->last_name)); ?>" required>
        </div>
        <div class="form-row">
          <label>Email</label>
          <input type="email" value="<?php echo e(auth()->user()->email); ?>" disabled style="background:var(--paper);color:var(--muted);cursor:not-allowed">
        </div>
