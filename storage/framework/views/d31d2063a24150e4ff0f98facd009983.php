...
<div class="kpi-grid" style="margin-bottom:24px">
  <div class="kpi"><div class="label">Total Commission</div><div class="value">₱<?php echo e(number_format($totalCommission, 2)); ?></div><div class="delta up">Platform earnings</div></div>
  <div class="kpi"><div class="label">Commission Records</div><div class="value"><?php echo e(number_format($commissionCount)); ?></div></div>
  <div class="kpi"><div class="label">Approved Users</div><div class="value"><?php echo e(number_format($approved)); ?></div><div class="delta up">Active accounts</div></div>
  <div class="kpi"><div class="label">Pending</div><div class="value"><?php echo e(number_format($pending)); ?></div><div class="delta <?php echo e($pending > 0 ? 'down' : ''); ?>">Awaiting review</div></div>
</div>
...
<div class="dash-grid">
  ...
  <div class="card">
    <div class="card-head">
      ...
      <a href="<?php echo e(route('admin.reports.export.sales')); ?>" class="btn btn-primary btn-sm">⬇ Export CSV</a>
    </div>
  ...
  <div class="stack">
    ...
    <div class="card">
      <div class="card-head">
        ...
        <a href="<?php echo e(route('admin.reports.export.commission')); ?>" class="btn btn-primary btn-sm">⬇ Export CSV</a>
      </div>
...
<?php endif; ?> Download Commission Report (CSV)</a>
        <a href="<?php echo e(route('admin.reports.export.sales')); ?>" class="btn btn-outline btn-block">📋 Download Sales Summary (CSV)</a>
      </div>
    </div>
