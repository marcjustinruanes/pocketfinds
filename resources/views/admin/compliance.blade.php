      ...
      <table class="dtable" id="compTable">
        ...
        <tbody>
          ...
          <tr class="rail-row rail-{{ $seller->status }}" data-type="{{ $seller->status }}">
            ...
            <td>
              @if($seller->id_file)
                <span class="doc-chip">📄 {{ basename($seller->id_file) }}</span>
              @else
            ...
            <div class="modal modal-lg">
              ...
              <div class="modal-body">
                <div class="detail-grid">
                  ...
                  @if($seller->id_file)
                  <div class="full"><div class="field-label">Submitted ID</div><div><span class="doc-chip">📄 {{ basename($seller->id_file) }}</span></div></div>
                  @endif
                </div>
              </div>
          ...
          @empty
          <tr><td colspan="6"><div class="empty"><div class="ic">🛡</div><h3>No sellers yet</h3></div></td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
