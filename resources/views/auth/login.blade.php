...
<div class="auth-shell">
    <main class="auth-card">
        <x-auth-brand-panel
            title="Welcome back to PocketFinds"
            subtitle="Sign in to manage your account and pick up right where you left off." />
        ...
        <section class="auth-form-panel">
            <div class="auth-form-wrap">
                ...
                <form class="auth-form" method="POST" action="{{ route('login.post') }}">
                    ...
                    <div class="auth-field">
                        ...
                        <div class="auth-input-wrap">
                            <input class="auth-input has-icon" id="email" name="email"
                                   type="text" value="{{ old('email') }}"
                                   placeholder="you@example.com" required autofocus>
                            <span class="auth-input-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 5L2 7"/></svg></span>
                        </div>
                    </div>
                    ...
                    <div class="auth-field">
                        ...
                        <div class="auth-input-wrap">
                            <input class="auth-input has-icon has-toggle" id="password" name="password"
                                   type="password" placeholder="Enter your password" required>
                            <span class="auth-input-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg></span>
                ...
                <div class="auth-secondary">
                    <a href="{{ route('google.login') }}" class="auth-secondary-btn" style="display:flex;align-items:center;justify-content:center;gap:8px;text-decoration:none">
