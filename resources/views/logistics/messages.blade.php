...
@section('page-sub', 'Communicate with admins, couriers, and sellers')
...
<div class="chat-shell">
  <div class="chat-list">
    ...
    @foreach(['admins' => 'Admin', 'couriers' => 'Couriers', 'sellers' => 'Sellers'] as $group => $label)
      @if(${$group}->isNotEmpty())
  ...
  <div class="chat-main">
    ...
    <div class="chat-body" id="chatBody">
      @forelse($messages as $msg)
        @include('logistics.partials.message-bubble', ['msg' => $msg, 'myId' => $myId])
      @empty
...
const SEND_URL   = '{{ route('logistics.messages.send') }}';
const POLL_URL   = '{{ route('logistics.messages.poll') }}';
const REPORT_URL = '{{ route('logistics.messages.report') }}';
