...
@section('page-sub', 'Manage your logistics profile')

@push('head')
<style>
  .card-head h2 { font-family: var(--font-body); font-weight: 600; font-size: 14px; }
    ...
    <div class="card-pad">
      <div style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
        ...
        <div>
          ...
          <span class="stamp stamp-active" style="margin-top:4px">Logistics Admin</span>
        </div>
      </div>
